...
/**
 * Classe Lista, implementada a partir  da interface ILista.
 * 
...
public class Lista implements ILista, Serializable {
    ...
    /** Método quee retorna o primeiro elemento da lista.
     *
     * @return primeiro
     */    
    public CelulaLista getPrimeiro() {
        return primeiro;
    }
    ...
    public void inserir(int index, Comparable o) {
        ...
        if (index == 0) {
            ...
            this.inserirFinal(o);
        } else if ((index > 0) && (index < this.obterTamanho())) {
            CelulaLista aux = primeiro;
    ...
    public Comparable remover(int index) {
        ...
        } else if ((index > 0) && (index < (this.obterTamanho() - 1))) {
            CelulaLista aux = primeiro;
            CelulaLista auxAnterior = primeiro;
