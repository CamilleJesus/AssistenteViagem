...
public class AssistenteViagemTest {
    ...
    public void setUp() throws Exception {
        ...
        atracao2 = new Restaurante(local1, "Vivas", new Coordenadas(-12.254778, -38.956394), "Kalilandia", CategoriaAtracao.RESTAURANTE, FaixaPreco.CARO, TipoCozinha.INTERNACIONAL);
        ...
        avaliacao3 = new AvaliacaoRestaurante(usuario2, atracao3, 5, "Agradavel", "Um ambiente bem descontraido e amistoso, Bem legal", format.parse("13/10/2014"), TipoVisita.AMIGOS, TipoRefeicao.JANTAR, 7, 10, 9);
        avaliacao4 = new AvaliacaoHotel(usuario1, atracao1, 4, "Bom pra relaxar!", "O GoldPalace é oq é há!", format.parse("13/10/2014"), ObjetivoVisita.NEGOCIOS, 8, 8, 8);
        ...
        avaliacao6 = new AvaliacaoRestaurante(usuario1, atracao2, 5, "Otimo Restaurante!", "Bom servico, as camas são uma delicia.", format.parse("14/10/2014"), TipoVisita.AMIGOS, TipoRefeicao.ALMOCO, 7, 10, 9);
        ...
        avaliacao8 = new AvaliacaoHotel(usuario2, atracao4, 4, "Oh My Good, esse hotel é tudo de bom", "Tem muita mulher gostosa", format.parse("12/04/2012"), ObjetivoVisita.TURISMO, 9, 6, 10);
    ...
    @Test 
    public void testCadastrarListarLocais() throws CampoVazioException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
    ...
    @Test
    public void testCadastrarLogarUsuario() throws DadoInexistenteException, CampoVazioException  {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
    ...
    @Test
    public void cadastrarBuscarHotelOuRestaurante() throws DadoInexistenteException, DadoExistenteException, CampoVazioException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
        ...
        assistente.cadastrarRestaurante(local1, "Vivas", new Coordenadas(-12.254778, -38.956394), "Kalilandia", CategoriaAtracao.RESTAURANTE, FaixaPreco.CARO, TipoCozinha.INTERNACIONAL);
    ...
    @Test
    public void testCadastrarBuscarLocal() throws DadoInexistenteException, CampoVazioException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
    ...
    @Test 
    public void testCadastrarListarAtracoesOrdemAlfabetica() throws DadoInexistenteException, CampoVazioException, DadoExistenteException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
    ...
    @Test
    public void testProcessarNovasAvaliacoes() throws ParseException, DadoInexistenteException, DadoExistenteException, CampoVazioException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
        ...
        usuario1.avaliarAtracao(atracaoAvaliada2, 2, "Pessimo", "Nunca passei por uma experiencia tao constrangedora", format.parse("12/10/2014"), TipoVisita.SOZINHO, TipoRefeicao.JANTAR, 4, 5, 3);
        usuario2.avaliarAtracao(atracaoAvaliada1, 4, "Bom pra relaxar!", "O GoldPalace é oq é há!", format.parse("13/10/2014"), ObjetivoVisita.TURISMO, 8, 8, 8);
    ...
    @Test
    public void testCadastrarAceitarListarAvaliacoes() throws ParseException, DadoInexistenteException, CampoVazioException, DadoExistenteException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
        ...
        usuario1.avaliarAtracao(atracaoAvaliada3,  2, "Pessimo", "Nunca passei por uma experiencia tao constrangedora", format.parse("12/10/2014"), TipoVisita.SOZINHO, TipoRefeicao.JANTAR, 4, 5, 3);
    ...
    @Test
    public void testRecalcularRankings() throws ParseException, DadoInexistenteException, CampoVazioException, DadoExistenteException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
        ...
        usuario1.avaliarAtracao(atracaoAvaliada1,4, "Bom pra relaxar!", "O GoldPalace é oq é há!", format.parse("13/10/2014"), ObjetivoVisita.TURISMO, 8, 8, 8);
        ...
        usuario1.avaliarAtracao(atracaoAvaliada3, 2, "Pessimo", "Nunca passei por uma experiencia tao constrangedora", format.parse("12/10/2014"), TipoVisita.AMIGOS, TipoRefeicao.JANTAR, 4, 5, 3);
    ...
    @Test
    public void testCadastrarListarAtracoesOrdemPontuacaoMedia() throws ParseException, DadoInexistenteException, CampoVazioException, DadoExistenteException {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
    ...
    @Test
    public void testSalvarCarregarSistema() throws DadoInexistenteException, Exception {
        AssistenteViagem.zerarSingleton();
        assistente = AssistenteViagem.getInstance();
        ...
        assistente.cadastrarRestaurante(local1, "Vivas", new Coordenadas(-12.254778, -38.956394), "Kalilândia", CategoriaAtracao.RESTAURANTE, FaixaPreco.CARO, TipoCozinha.INTERNACIONAL);
