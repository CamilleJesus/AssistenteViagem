...
public class AvaliacaoHotelTest {
    ...
    public void setUp() throws Exception {
        ...
        avaliacao = new AvaliacaoHotel(usuario, hotel, 4, "Bom pra relaxar!", "O GoldPalace é oq é há!", data, ObjetivoVisita.TURISMO, 8, 8, 8);
    }
    ...
    public void testBasic() throws ParseException {
        ...
        assertEquals(ObjetivoVisita.TURISMO, avaliacao.getObjetivoVisita());
