...
public class AvaliacaoRestauranteTest {
    ...
    public void setUp() throws Exception {
        ...
        avaliacao = new AvaliacaoRestaurante(usuario, restaurante, 2, "Pessimo", "Nunca passei por uma experiencia tão constrangedora", data, TipoVisita.AMIGOS, TipoRefeicao.JANTAR, 4, 5, 3);
    }
    ...
    public void testBasic() throws ParseException {
        ...
        assertEquals(TipoVisita.AMIGOS, avaliacao.getTipoVisita());
