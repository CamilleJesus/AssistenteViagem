...
public class AvaliacaoTest {
    ...
    public void setUp() throws Exception {
        ...
        atracao = new Restaurante(local, "Vivas", new Coordenadas(-12.254778, -38.956394), "Kalilandia", CategoriaAtracao.RESTAURANTE, FaixaPreco.CARO, TipoCozinha.INTERNACIONAL);
