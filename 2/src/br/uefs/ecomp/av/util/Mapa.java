...
/**
 * Classe Mapa, implementada a partir dos métodos da interface IMapa.
 * 
...
public class Mapa implements IMapa, Serializable {
    ...
    public void inserir(Object chave, Object valor) {
        ...
        //Num mapa não podem haver chaves iguais:
    ...
    public void redimensionar() {
        //Verifica e/ou transforma o dobro do tamanho em um número primo para
        // dificultar a ocorrência de colisão:
        int t = primo(this.obterTamanho() * 2);
        Object[] temp = new Object[t];
        Iterador iterador = this.par();        
        Lista lista = new Lista();
 
        //As células do mapa são passadas para uma lista:
        while (iterador.temProximo()) {            
            CelulaMapa aux = ((CelulaMapa) iterador.obterProximo());
            lista.inserirFinal(aux);
        }
        
        //Posteriormente, são realocadas no novo mapa:
