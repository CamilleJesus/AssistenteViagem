...
public class ControllerUsuario {
    ...
    public void cadastrarHotel(Local local, String nome, Coordenadas localizacao,
        ...
        assistente.cadastrarHotel(local, nome, localizacao, bairro, categoria,
    ...
    public void avaliarRestaurante(int pontos, String titulo, String texto, Date
            data, TipoVisita tipoVisita, TipoRefeicao tipoRefeicao, int atendimento,
            int comida, int custoBeneficio) {
